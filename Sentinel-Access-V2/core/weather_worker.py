...
def generate_report(location, report_type, coords, output_dir):
    ...
    c.drawString(50, height - 50, f"Weather Report: {location}")
    
    c.setFont("Helvetica", 11)
    c.drawString(50, height - 80, f"Coordinates: {coords[0]:.4f}, {coords[1]:.4f}")
    c.drawString(50, height - 100, "Temperature: 22°C | Condition: Partly Cloudy")
    c.drawString(50, height - 120, "Wind: 15 km/h | Humidity: 65%")
